...
function buscarPersona() {
    let persona = document.getElementById("presupuestos-search").value;
    if (persona.trim() !== "") {
...
function agregarIntegrante() {
    let inputIntegrante = document.getElementById("presupuestos-buscar-integrante");
...
function actualizarListaIntegrantes() {
    let listaIntegrantesDiv = document.getElementById("presupuestos-lista-integrantes");
    ...
    integrantes.forEach((integrante, index) => {
        ...
        div.classList.add('presupuestos-integrante-item');
        div.innerHTML = `
            ${integrante}
            <span class="presupuestos-eliminar" onclick="eliminarIntegrante(${index})">✖</span>
        `;
...
function mostrarFormulario() {
    ...
    document.getElementById("presupuestos-formulario").style.display = "block";
    document.getElementById("presupuestos-overlay").style.display = "block";
}

// Función para crear el grupo
function crearGrupo() {
    let nombreGrupo = document.getElementById("presupuestos-nombre-grupo").value;
    let saldo = document.getElementById("presupuestos-saldo").value;
    let dueno = document.getElementById("presupuestos-nombre-dueno").value;
...
function actualizarGrupos() {
    let gruposDiv = document.getElementById("presupuestos-grupos-creados");
    gruposDiv.innerHTML = ""; // Limpiamos la sección de grupos

    // Iteramos sobre todos los grupos y los mostramos
    grupos.forEach(grupo => {
        let div = document.createElement('div');
        div.classList.add('presupuestos-grupo-card');
        div.innerHTML = `
...
function resetFormulario() {
    ...
    document.getElementById("presupuestos-nombre-grupo").value = "";
    document.getElementById("presupuestos-saldo").value = "";
    ...
    document.getElementById("presupuestos-formulario").style.display = "none";
    document.getElementById("presupuestos-overlay").style.display = "none";
}
